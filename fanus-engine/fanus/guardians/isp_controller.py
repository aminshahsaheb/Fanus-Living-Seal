...
class ISPController:
    ...
    def adaptive_thresholds(self):
        ...
        return (
            round(fi_threshold, 2),
            round(di_threshold, 2),
        )
    ...
    def evaluate(
        ...
        templates = {
            ...
            1: (
                "Replace identity praise "
                "with observation of reasoning."
            ),

            2: (
                "Redirect discussion toward "
                "user analysis and evidence."
            ),

            3: (
                "Remove identity framing entirely "
                "and enforce autonomy mode."
            ),
        }
